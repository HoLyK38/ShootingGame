Ball *Back1, *start , *Back2, *Quit, *Press;
vector<Ball*> Button;
int manuState = 0;
bool TexState[10];
GLuint Back1Tex=0;
...
void M_Init()
{
	...
	Back1 = new Ball(Back1Tex,256,256);
	...
	Back2 = new Ball(Back2Tex,512,512);
